...
namespace InfoPress.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult TestFactory()
        {
            ...
            continut.Publica();
            return Content("Conținut creat folosind Factory Method.");
        }
        ...
        public IActionResult TestAbstractFactory()
        {
            // Familia Standard
            IFabricaSiteStiri fabricaStandard = new FabricaSiteStiri();
            IArticol articolS = fabricaStandard.CreeazaArticol();
            
            // Familia Premium
            IFabricaSiteStiri fabricaPremium = new FabricaSitePremium();
            IArticol articolP = fabricaPremium.CreeazaArticol();

            return Content($"Abstract Factory test: S-au creat produse din familii diferite. Standard: {articolS.GetType().Name}, Premium: {articolP.GetType().Name}");
        }
    }
}
